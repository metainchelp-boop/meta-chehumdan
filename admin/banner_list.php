...
$admin[bn_code][""] = "전체";
$que = sql_query("select * from nfor_banner_group where 1 order by gp_id desc");
while($row = sql_fetch_array($que)){
	$admin[bn_code][$row[gp_code]] = $row[gp_name];
}
...
<tr>
	<th>배너그룹</th>
	<td><?=admin_select($_GET,"bn_code","width-300p","","0")?></td>
	<th>노출여부</th> 
	<td><?=admin_radio($_GET,"bn_use","","","0")?></td>
</tr>
<tr>
	<th>검색어</th>
	<td colspan="3">
...
<tr>
	...
	<th><div class="form-inline">배너그룹 <?=admin_button("bn_group_btn","추가","btn-sm")?></div></th>
...
<tr>
	...
	<td><?=admin_echo($row,"bn_code")?><br><?=$row[bn_code]?></td>
