...
if($mode=="list_update1"){
	...
	$mc_pb_result = mc_pb_set_step_atomic($connect_db, $mc_pb_ids, 3, array('changeDatetime'=>true));
	...
	for($i=0; $i<count($chk); $i++){
		...
		nfor_send("bank_step3",$mb[mb_email],$mb[mb_hp],$mb[mb_no],"","point_bank_list.php");
	}
	json_return("입금완료로 상태를 변경하였습니다","ok");
}
...
<div class="bottom_btn">
	...
	<div class="form-inline">
	<?=admin_button("list_update1", "입금완료", "btn btn-lg btn-red")?>
...
$(document).on("click", "#list_update1", function(){
	nfor_list_reload('입금완료','list_update1');
});
