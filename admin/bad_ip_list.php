...
$admin[keyword_type] = array(""=>"전체","bd_ip" => "아이피", "bd_memo"=>"차단사유");
$admin[period_type] = array("bd_insert_datetime" => "등록일자", "bd_update_datetime" => "수정일자");
...
<tr>
	...
	<td><?=$row[bd_ip]?></td>
	<td class="textleft"><?=$row[bd_memo]?></td>
	<td><?=substr($row[bd_insert_datetime],0,10)?></td>
