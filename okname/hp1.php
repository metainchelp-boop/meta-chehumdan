...
$RETURN_URL = "https://".$_SERVER['HTTP_HOST']."/okname/hp2.php";// 인증 완료 후 리턴될 URL (도메인 포함 full path)
...
$license = $nfor['root_path']."/okname/".$CP_CD."_IDS_01_".$target."_AES_license.dat";
