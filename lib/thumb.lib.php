...
function thumbnail($dirandfilename, $thumb_width, $thumb_height, $is_create, $is_crop=false, $crop_mode='center', $is_sharpen=false, $um_value='100/0.5/3'){




	$filename = basename($dirandfilename);
	$source_path = dirname($dirandfilename);
