...
<div class="note_receive_top">
	<span>보낸사람  <b class="txt_num"><?=$note[no_send_id]?></b></span>
...
<ul>
<li><span class="btn_pack"><a href="note_receive_list.php" class="btn_lg black">목록보기</a></span></li>
<li><span class="btn_pack"><a href="note_form.php?no_receive_id=<?=$note[no_send_id]?>" class="btn_lg black">답장하기</a></li>
