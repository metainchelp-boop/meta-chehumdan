...
<style>
.find_password_wrap{ margin:0px; padding:20px; width:100%; background-color:#FFF; box-sizing:border-box; -webkit-box-sizing:border-box; letter-spacing:-.0625em; }
...
.find_password_wrap .tbl{ margin-bottom:20px;}
.find_password_wrap .tbl th{ text-align:left;  font-size: .8em; line-height: 1.43em;  color: #959da6; font-weight:normal; letter-spacing:-.0625em; }
.find_password_wrap .tbl td{padding:3px; }

.find_password_wrap .mb_hp { margin:10px 0px; }
.find_password_wrap .mb_email { margin:10px 0px; }


.find_password_wrap .txt_lst li {position: relative;margin-left: 2px; padding-left: 6px;}
.find_password_wrap .txt_lst li:before {display: block; position: absolute; top: 5px;left: -1px;width: 2px; height: 2px;background-color: #828282; content: '';}
.find_password_wrap .btm {margin-top:30px; padding-top: 6px; border-top: 1px solid #e4e4e4;}
.find_password_wrap .txt_lst { clear: both; line-height: 16px;color: #999;font-size: 0.7em;}
#find_password_email { margin-top:20px; }
</style>
