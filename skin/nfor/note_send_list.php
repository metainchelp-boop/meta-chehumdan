...
<span>보낸쪽지 <b class="txt_num point-color1"><?=$total_count?></b>통</span>
...
<div class="note_box">
	...
	<a href="note_send_view.php?no_id=<?=$row[no_id]?>" style="display:block;">
	<span class="memo"><?=$row[no_memo]?></span>
	<div class="bottom_info">
		<span class="name"><?=$row[no_receive_id]?></span>
