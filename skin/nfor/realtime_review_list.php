...
.realtime_review_wrap .best_wrap{background:url(/skin/demo_2/img/pr_top_bg3.png)right top no-repeat;background-color:#fef4f4; }
.realtime_review_wrap .best_wrap .best_title{padding:50px; font-size:26px; color:#000; letter-spacing:-1px; text-align:center;}
.s_txt{font-size:16px; display:block; margin-top:10px;}
.review_list{padding:15px; background-color:#fff; }
</style>
