...
<style>
.sleep_wrap { width:100%; background: #ffffff; padding:20px; box-sizing:border-box; -webkit-box-sizing:border-box; }
.sleep_wrap .sleep_tit{font-size:24px;display:block; font-weight:200}
.sleep_wrap .sleep_tit2{font-size:16px;display:block; }
.sleep_wrap .sleep_tit3{font-size:12px;display:block; color:#999;}
...
.asign_number_wrap #asign_number { padding:0; width:100%; height: 42px; font-size:16px; margin-top:15px; background-color:#fff;  border:solid 1px #666; color:#666; font-weight:100; letter-spacing:-1px }
.asign_number_wrap .asign_confirm { padding:0; width:100%; height: 42px; font-size:16px; margin-top:15px; background-color:#666;  border:solid 1px #666; color:#FFF; font-weight:100; letter-spacing:-1px  }



.asign_type_wrap .sleep_tit2 { margin-bottom:20px; font-weight:bold; }
.asign_type_wrap label { display:block; margin-bottom:15px; }
