...
.bad_report_wrap{font-family:"Nanum Gothic"; padding:10px; margin:10px; border:1px solid #eee; background-color:#fff; box-sizing:border-box; -webkit-box-sizing:border-box;}
.bad_report_title{border-bottom:1px solid #000; height:25px; line-height:25px; padding:0px 10px; font-size:20px;font-weight:bold;}
...
.btngo3{display:block;width:100%; font-weight:bold; padding:10px 20px; text-align:center;  background:#4f4e4d; border:1px solid #4f4e4d; color:#FFF; margin:20px auto;}
...
<tr>
	<td colspan="2" style="padding:0px;"><textarea name="no_memo" rows="17" style="width:100%; height:250px;"  class="inp"></textarea></td>
</tr>
</table>

<div  style="margin-top:10px; text-align:center;">
	<input type="submit" value="쪽지보내기" class="btngo3">
</div>
