...
select:focus, input[type=text]:focus, input[type=email]:focus, input[type=password]:focus, input[type=number]:focus { border:solid 1px #ff3478; }

.p_msg { font-size: 12px; line-height: 16px;  color: #9ea5ae; }

#mb_hp_msg { margin:5px 0px; }  
#mb_hp_asign { display:none; }
#asign_send_btn { cursor:pointer; display:block; height:40px; line-height:40px; font-size:15px; text-align:center;  color:#ff3478; border:solid 2px #ff3478; background-color:#fff; }
...
#mb_join_btn { display:block; width:100%; height:45px; line-height:45px; text-align:center; padding:0px; margin:0px; margin:20px 0px 10px;; font-size:16px; font-weight:bold; background-color:#ff3478; border:solid 1px #ff3478; color:#fff; }
#mb_leave_btn{ display:block; width:100%; height:45px; line-height:45px; text-align:center; padding:0px; margin:0px; margin:0px 0px; font-size:16px; font-weight:bold; border:solid 1px #ff3478; color:#fff; }
...
<div class="mb_join_wrap" id="member_info">
	...
	<div class="mb_join_row"><?=admin_text($write,"mb_hp",""," placeholder=\"휴대폰번호(-없이 입력)\"")?></div>
	...
	<div class="mb_join_row"><?=admin_text($write,"mb_id","",($write[mb_id]?"readonly":"")." placeholder=\"아이디\"")?></div>
	...
	<div class="mb_join_row"><?=admin_password($write,"mb_password_now","","placeholder=\"현재 비밀번호를 입력해 주세요\"")?></div>

	<div class="mb_join_row"><?=admin_password($write,"mb_password","","placeholder=\"새 비밀번호를 입력해주세요\"")?></div>
	<p id="mb_password_msg" class="mb_row_p">영문/숫자 또는 특수문자 조합 6~16자리로 입력해 주세요.</p>

	<div class="mb_join_row"><?=admin_password($write,"mb_password_confirm","","placeholder=\"새 비밀번호를 한번더 입력해주세요\"")?></div>
...
<style>
.innpputt{border: 1px solid #e0e0e0; padding-left:10px;   height: 40px; line-height:40px;  font-size:14px; box-sizing:border-box; -webkit-box-sizing:border-box; }
.innpputt input[type="text"] {display:inline-block; width:38%; height: 40px;margin: -2px 0px 0px;  border: 0px solid #e0e0e0; color: #666;  background: none; /* outline: none; */  box-shadow: none;-webkit-appearance: none;  -webkit-appearance: none; -moz-appearance: none;  letter-spacing: -1px;vertical-align: middle;padding-left:0px; box-sizing:border-box; -webkit-box-sizing:border-box; }
</style>


	<? if($member_config[mb_blog_use] or $member_config[mb_instagram_use] or $member_config[mb_youtube_use]){ ?>
	<p class="mb_join_title">운영채널</p>

	<? if($member_config[mb_blog_use]){ ?>	
	<div class="mb_join_row">
	<div class="innpputt">	
	https://blog.naver.com /<?=admin_text($write,"mb_blog","","placeholder=\"블로그 아이디\"")?></div>
	</div>
	...
	<?=admin_submit("mb_join_btn", "회원정보수정")?>

	<a href="member_leave.php" id="mb_leave_btn" style="color:#ff3478;">회원탈퇴</a>
