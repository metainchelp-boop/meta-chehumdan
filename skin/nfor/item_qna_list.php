...
.qna_list .qna_memo { color:#444; font-size:13px; letter-spacing:-1px; padding:15px 10px 15px;; }

.qna_list .q_li .qna_list_name { position:relative; font-size:13px; color:#444; padding-left:38px; letter-spacing:-1px; }
.qna_list .q_li .qna_list_name b { width:32px; height:22px; top:0px; background-color:#2fcbe0; color:#fff; line-height:22px; text-align:center;left:0px; border-radius:10px; font-size:11px;position:absolute;}

.qna_list .a_li .qna_list_name { position:relative; font-size:13px; color:#444; padding-left:45px; letter-spacing:-1px; }
.qna_list .a_li .qna_list_name b { width:32px; height:22px; top:0px; left:10px; background-color:#9ea5ae; color:#fff; line-height:22px; text-align:center; border-radius:10px; font-size:11px; position:absolute; }
...
.qna_form_wrap { padding:10px; }
.caution { padding:10px; background-color:#fafafa; margin-top:10px; }
.caution li { font-size:11px; color:#9ea5ae; letter-spacing:-.07em; }
.qna_form_wrap h3 { font-size:14px; font-weight:normal; display:block; padding:10px 0px; }
.qna_form_wrap .qa_memo { height:80px; margin-bottom:10px; border: 1px solid #cacaca;}
.btn_item_qna_submit{ border:solid 1px #e83862; background-color:#fff; color:#e83862; letter-spacing:-.07em; }
.list_button { overflow:hidden; }
...
.list_button li .btn_item_qna_cancel_button { margin-right:5px; border:solid 1px #9ea5ae;; background-color:#fff; color:#9ea5ae;; letter-spacing:-.07em; }
.list_button li .btn_item_qna_button { margin-left:0px; border:solid 1px #e83862; background-color:#fff; color:#e83862; letter-spacing:-.07em; }
</style>
...
<div id="qna_form">
	<div class="qna_form_wrap">
		...
		<ul class="list_button">
			<li><input type="button" value="취소하기" class="btn_item_qna_cancel_button"></li>
