...
<div class="board_write">
	...
	<tr>
		<td colspan="2">
		<div class="img_upload_btn mar_top10">
		...
		<span class="coution mar_top10" >※ 사진은 <b class="txt_num">10MB</b>이하의 <b class="txt_num">PNG, GIF, JPG</b> 파일만 등록 가능합니다.</span>
		</td>
	...
	<ul>
		<li><span class="btn_pack"><?=admin_submit("submit_btn", "글쓰기","btn_lg black")?></span></li>
		<li><span class="btn_pack"><a href="board_list.php?tbl=<?=$board[bo_tbl]?>" class="btn_lg white">목록으로</a></span></li>
	</ul>
	</div>
</div>
