...
/* 상품문의리스트*/
 ...
 .comment_list_btn .disinline{display:inline-block;}
 .comment_list{padding:0px;}
</style>
...
<div >
	<h3 style="font-size:18px; font-weight:normal; margin-bottom:10px; padding-left:10px;">댓글</h3>
...
<li class="q_li" id="ct_li_<?=$comment[ct_id]?>">
	...
	<div class="comment_list_btn">
		<span class="btn_pack disinline"><button type="button" class="reply btn_sm white" data-ct_id="<?=$comment[ct_id]?>">답변</button></span>
		<?php if($comment[ct_access]){ ?>
		<span class="btn_pack disinline"><button type="button" class="update btn_sm white" data-ct_id="<?=$comment[ct_id]?>">수정</button></span>
		<span class="btn_pack disinline"><button type="button" class="delete btn_sm white" data-ct_id="<?=$comment[ct_id]?>">삭제</button></span>
		<?php } ?>
	</div>
...
<li class="a_li" id="ct_li_<?=$comment_reply[ct_id]?>">
	...
	<div class="comment_list_btn">
		<span class="btn_pack disinline"><button type="button" class="update btn_sm white" data-ct_id="<?=$comment_reply[ct_id]?>">수정</button></span>
		<span class="btn_pack disinline"><button type="button" class="delete btn_sm white" data-ct_id="<?=$comment_reply[ct_id]?>">삭제</button></span>
	</div>
	<? } ?>
</li>
<?
...
<li class="q_li" id="ct_li_<%=ct_id%>">
	...
	<div class="comment_list_btn">
		<span class="btn_pack disinline"><button type="button" class="reply btn_sm white" data-ct_id="<%=ct_id%>">답변</button></span>
		<% if(ct_access=="1"){ %>
		<span class="btn_pack disinline"><button type="button" class="update btn_sm white" data-ct_id="<%=ct_id%>">수정</button></span>
		<span class="btn_pack disinline"><button type="button" class="delete btn_sm white" data-ct_id="<%=ct_id%>">삭제</button></span>
		<% } %>
	</div>
...
<li class="a_li" id="ct_li_<%=data.ct_id%>">
	...
	<% if(data.ct_access=="1"){ %>
	<div class="comment_list_btn">
		<span class="btn_pack disinline"><button type="button" class="update btn_sm white" data-ct_id="<%=data.ct_id%>">수정</button></span>
		<span class="btn_pack disinline"><button type="button" class="delete btn_sm white" data-ct_id="<%=data.ct_id%>">삭제</button></span>
	</div>
	<% } %>
