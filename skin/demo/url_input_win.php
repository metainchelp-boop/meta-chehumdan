...
.url_input_wrap .txt1{ display:block; font-size:24px; font-weight:300; color:#000; margin-top:15px;}
.url_input_wrap .txt2{ display:block;  font-size:15px; color:#999; margin-bottom:20px;}
.url_input_wrap .application_tbl{width:100%; border-top:solid 1px #333; padding-top:20px; }
.url_input_wrap .application_tbl li {padding:5px 0px 5px; text-align:left; font-size:16px; font-weight:300; }
.url_input_wrap .application_tbl li textarea { width: 100%; height: 250px; padding: 15px; border: 1px solid #d0d0d0; line-height: 16px; color: #828284; ; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; }
.url_input_wrap .application_tbl input[type=text] {padding-left: 11px;  font-size:14px; border:1px solid #e0e0e0;  width:100%; background-color:#FFF;  height:35px; line-height:35px;  box-sizing: border-box; color: #828284; vertical-align: middle; }
.url_input_wrap .url_input_tit{ display:block; line-height: 35px; font-size: 20px; color: #000;  position: relative;   padding: 0px 0px;} 
...
.url_input_wrap .btn01{display:block; width:100%; color:#FFFFFF; margin:0 auto; padding:10px; border: solid 1px #515b6b; background-color:#515b6b; line-height:25px;  font-size:18px;  -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;}
...
.box_url{min-height:110px; background-color:#f3f3f3; padding:20px; color:#000; margin-bottom:20px;}
...
.basic_form{border-bottom:solid 1px #dcdcdc;}
...
.basic_form .tit_basic{ display:block;font-family: 'notokr-regular';   color:#000; letter-spacing:-1px;  font-size:18px; margin-bottom:10px;}
...
.tab-cont { display:none; border:solid 1px #dcdcdc;  padding:20px; min-height:140px; background-color:#fff;}
#tab1 { display:block; }
...
<div class="url_input_wrap">
	...
	<ul class="application_tbl">
		...
		<li>
			<div class="box_url"><?=nl2br($write[rv_edit])?></div>
		</li>
	</ul>
	<?php } ?>
	...
	<div class="box_url">
		<div class="basic_form">
			<ul>
				...
				<li id="nfor_page33">
					<span class="tit_basic">해시태그<!-- <b data-clipboard-target="#cp_hashtag" class="key_copy">키워드복사</b> --></span>
	...
	<ul class="application_tbl">
		...
		<li>
			<div class="board_btn_zone"><span class="btn_pack"><input type="button" class=" btn_lg black" id="rv_submit_btn" value="등록하기" style=""></div>
		</li>
	</ul>
