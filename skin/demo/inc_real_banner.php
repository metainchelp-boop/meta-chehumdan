<style type="text/css">
.mainviswrap{  position:relative;  width:100%; background-color:#ffffff; padding:30px 0px 0px 0px; }	
...
<div class="mainviswrap">
	...
	<section class="slider_center">
		...
		<?php
		for($i=0; $i<count($return[banner][realtime_review_list]["list"]); $i++){
			$banner = $return[banner][realtime_review_list]["list"][$i];
		?>
