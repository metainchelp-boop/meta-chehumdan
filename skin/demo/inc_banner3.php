...
.swiper-container-banner3 .swiper-slide img { width:100%; }
...
<div class="mainviswrap">
	...
	<section class="slider_center">
		...
		<div class="swiper-container swiper-container-banner3">
		<div class="swiper-wrapper">
		<?php
		for($i=0; $i<count($return[banner][index_slider3]["list"]); $i++){
			$banner = $return[banner][index_slider3]["list"][$i];
		?>
