<style type="text/css">
.mainviswrap{  position:relative;  width:100%; background-color:#ffffff; padding:30px 0px 50px 0px; }	

@media (max-width:1444px){
.slider_center { width:820px;   position:relative;  }
.swiper-button-prev-banner{position:absolute; top:43%; left:20px; z-index:9999;}
.swiper-button-next-banner{position:absolute; top:43%; right:20px;  z-index:9999;}
}

@media (min-width:1444px){
.slider_center {width:1156px;  position:relative;   }
.swiper-button-prev-banner{position:absolute; top:43%; left:20px; z-index:9999;}
.swiper-button-next-banner{position:absolute; top:43%; right:20px;  z-index:9999;}
}
...
<div class="mainviswrap">
	...
	<section class="slider_center">
		...
		<?php
		for($i=0; $i<count($return[banner]["board_list_".$tbl]["list"]); $i++){
			$banner = $return[banner]["board_list_".$tbl]["list"][$i];
		?>
