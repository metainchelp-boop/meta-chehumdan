...
?>
<style>
.campaign_qna{position:relative;  width:100%;padding:0px;  -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;}
.campaign_qna .title{ padding: 20px 0; margin: 0 40px; font-size: 26px; font-weight: 700; color: #222; line-height: 1.5;border-bottom: 1px solid #333;  text-align: left;}
.campaign_qna .inner{padding: 10px 0; margin: 0 40px; position:relative; }
...
.campaign_qna_write{border-top:1px solid #fff;padding: 0; margin-top:20px;}
